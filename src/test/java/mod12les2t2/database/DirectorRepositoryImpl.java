...
//            "WHERE \"TestSchema\".\"Movies\".\"genre\" = ?";
    ...
    public static final String getDirectorsByGenreByQuery = "SELECT m.Director, d.birth_date, d.first_name, d.last_name, d.country" +
            "FROM \"TestSchema\".\"Movies\" as m" +
            "INNER JOIN \"TestSchema\".\"Directors\" as d" +
            "ON m.Directors = d.id" +
            "WHERE \"TestSchema\".\"Movies\".\"genre\" = ?";
    ...
    public List<Director> get(List<String> genres) {
        ...
        try(PreparedStatement preparedStatement = connection.prepareStatement(getDirectorsByGenreByQuery)){
            ...
            for(String genre: genres){
                ...
                resultSet.next();
                do{
                    resultListOfDirectors.add(new mod12les2t1.database.DirectorRepositoryImpl(connection).
